...
export function BrandLogo({ size = 30, className = "" }: BrandLogoProps) {
  return (
    <div
      className={`relative flex items-center justify-center rounded-xl bg-gradient-to-br from-blue-600 via-blue-500 to-indigo-600 shadow-md shadow-blue-600/25 shrink-0 ${className}`}
    ...
    >
      ...
      >
        ...
        {/* Intelligent central flow core */}
        <circle cx="12" cy="12" r="1.8" fill="#93c5fd" />
      </svg>
    </div>
  );
}
